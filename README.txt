...
You can find the JSON endpoints at:

All data in json:
http://localhost:5000/catalogue.json

A specific item's data in json:
http://localhost:5000/category/<string:category_name>/<string:item_name>/json
